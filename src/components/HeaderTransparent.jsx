        ...
        <div className="w-[95vw] md:w-5/6 xl:w-2/3 flex flex-col text-white">
            <div className="flex justify-between items-center py-6">
                <a href="https://www.anove.ai">
                    <img onClick={() => navigate("/")} src="src/assets/Primary Logo White.svg" className="w-[25vw] sm:w-[18vw] md:w-[12vw] xl:w-[7vw] cursor-pointer"/>
                </a>
                    ...
                    <div>
                        <div className="flex cursor-pointer" onMouseEnter={() => setHoveredText('anove')} onMouseLeave={() => setHoveredText('')}>
                            ...
                            <img
                                ...
                                src="src/assets/arrow_down (2).svg"
                            />
                        </div>
                        {
                            (openDropdown === 'anove') &&
                ...
                <div className="hidden lg:flex gap-5 justify-between items-center">
                    ...
                    >
                        Get Anove
                        <img className='-rotate-90 transform translate-x-0 group-hover:translate-x-2 transition duration-500 ease-in-out'src="src/assets/arrow_down (2).svg" />
                    </button>
                </div>
                <img onClick={() => toggleDropdown('burger')} className="flex lg:hidden w-[8vw]" src="src/assets/menu_burger.svg"/>
